...
import carposter from '../../../../assets/images/bikeposter.png';
    ...
    return (
        <React.Fragment>
            <div className="mx-auto">
                <div className="bg-red-500 text-white p-8 py-4 flex flex-col md:flex-row space-between items-center justify-between relative overflow-hidden">
                    <div className="flex flex-col lg:ml-14 xl:ml-28 max-w-sm lg:max-w-xl z-10">
                        <h4 className="text-xl sm:text-2xl text-center md:text-left font-bold text-white md:pb-2">
                            “Your Vehicle Needs @ Your Fingertips”
                        </h4>
                        {/* <Text
